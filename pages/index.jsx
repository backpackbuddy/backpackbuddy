                ...
                <section className="why bg-light">
                    <Container>
                        <h2 className="text-center">
                            Mengapa memilih Backpack Buddy?
                        </h2>
                        <p className="description text-center font-weight-normal mx-auto mb-4">
                            Kami melayani konsultasi rute wisata harian dengan
                            informasi yang lebih lengkap secara langsung bersama
                            konsultan kami
                        </p>
                        ...
                        <Row>
                            {[
                                ...
                                },
                                {
                                    ...
                                    description:
                                        "Para konsultan merupakan traveler asli Bali.",
                                },
                                {
                                    Icon: CustomIcon,
                                            ...
                                            <Card.Body>
                                                ...
                                                <Card.Text
                                                    className={[
                                                        ...
                                                        !isOpen[index] &&
                                                            "testimonials__message--truncate",
                                                    ].join(" ")}
                                                >
                                                    <QuoteIcon
                                                        fill="gold"
